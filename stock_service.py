...
def _build_chip_fields(chip_row):
    ...
    return {
        ...
        "margin_purchase_change": to_int_or_none(chip_row.get("margin_purchase_change")),
        "margin_purchase_change_score": to_float_or_none(chip_row.get("margin_purchase_change_score")),
        "short_sale_change": to_int_or_none(chip_row.get("short_sale_change")),
        "short_sale_change_score": to_float_or_none(chip_row.get("short_sale_change_score")),
        ...
        "margin_purchase_change_t0": to_int_or_none(chip_row.get("margin_purchase_change_t0")),
        "margin_purchase_change_t1": to_int_or_none(chip_row.get("margin_purchase_change_t1")),
        "margin_purchase_change_t2": to_int_or_none(chip_row.get("margin_purchase_change_t2")),
        "short_sale_change_t0": to_int_or_none(chip_row.get("short_sale_change_t0")),
        "short_sale_change_t1": to_int_or_none(chip_row.get("short_sale_change_t1")),
        "short_sale_change_t2": to_int_or_none(chip_row.get("short_sale_change_t2")),
